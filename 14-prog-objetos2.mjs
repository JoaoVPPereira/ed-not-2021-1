...
class FormaGeometrica {
    ...
    // gerarum erro do tipo Error.
    constructor(base, altura, tipo) {
        // base, altura e tipo são os PARÂMETROS do constructor

        // Atribuindo valores iniciais a PROPRIEDADES. O setter de cada
        // uma delas será chamado, faznedo as validações.
        this.base = base
        this.altura = altura
        this.tipo = tipo
...
try {
    ...
    forma1 = new FormaGeometrica(5.4, 7.7, 'T') // -> parâmetros do constructor
...
// trata-lo sem abortar a execução do programa
catch(erro) {
...
try {
    // Criando objetos a partir da classe
    forma3 = new FormaGeometrica(4, 3, 'E') // -> parâmetros do constructor
...
// Tentanto adicionar uma propriedade 'descricao' ao objeto. Não dá certo,
// pois o objeto foi selado no final do constructor, impedindo esse tipo de operação.
// forma1.descricao = 'batata'
// console.log(forma1)

// Lendo o atributo base da forma1 (será adicionado o getter)
