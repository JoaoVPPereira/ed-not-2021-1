...
let pessoa = {
    ...
    sexo: 'M',
    ocupacao: 'estudante',
    // Nomes de propriedades podem ter espaço e/ou acentos, mas precisam estar acompanhadas de aspas
...
// Variáveis:
// prop -> a variável que irá conter o nome de cada uma das propriedades do objeto ( pode ser qualquer nome válido de variável)
